...
function fetchData(callback) {
    FB.api('/me?fields=photos.limit(100){id,name,picture,tags,likes.limit(100),comments.limit(100)},feed{id,message,type,with_tags,likes.limit(100),comments.limit(100)}', function(resp) {
